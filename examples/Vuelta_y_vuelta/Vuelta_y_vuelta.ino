...
void setup()
{
  InitSR(3,4,5,2); //Aqui inicializamos los pines de conexion de los registros de desplazamiento con el Arduino. Sintaxis: InitSR(int PinDatos,Int PinReloj,Int PinEnable,Int NºRegistrosConcatenados);
  myStepperA.SetSpeed(60);//Seleccionamos la velocidad de rotacion de los motores en 60 RPM.
  myStepperB.SetSpeed(60);  
  myStepperC.SetSpeed(60);
  myStepperD.SetSpeed(60);
